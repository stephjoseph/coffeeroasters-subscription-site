...
const Footer = () => {
  return (
    <footer className='mb-[4.5rem] flex w-[87.2%] max-w-[1920px] flex-col items-center gap-12 bg-[#2C343E] py-[3.5rem] md:w-[89.71%] md:gap-0 md:py-[3.375rem] xl:mb-[5.5rem] xl:flex-row xl:items-center xl:py-12 xl:px-[5.313rem]'>
      ...
      >
        <Link href='/'>
          <a className='hover:text-light-cream active:text-light-cream'>Home</a>
        </Link>
        <Link href='/about'>
          <a className='hover:text-light-cream active:text-light-cream'>
            About Us
          </a>
        </Link>
        <Link href='/plan'>
      ...
      <div className='flex items-center gap-6 xl:ml-auto'>
        <Link href='/'>
          <a className='group flex items-center justify-center'>
            <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'>
              <path
                className='group-hover:fill-pale-orange group-active:fill-pale-orange'
                fill='#FEFCF7'
        ...
        <Link href='/'>
          <a className='group group flex items-center justify-center'>
            <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24'>
              <path
                className='group-hover:fill-pale-orange group-active:fill-pale-orange'
                fill='#FEFCF7'
