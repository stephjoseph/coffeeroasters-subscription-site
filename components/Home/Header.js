...
const Header = () => {
  return (
    <header className='mb-[7.5rem] flex w-[87.2%] flex-col items-center gap-10 rounded-[10px] px-6 py-[6.25rem] text-center md:mt-[0.813rem] md:w-[89.71%] md:items-start md:py-[6.5rem] md:px-[3.625rem] md:text-left'>
